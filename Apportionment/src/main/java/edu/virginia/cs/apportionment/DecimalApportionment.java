...
public class DecimalApportionment {
    ...
    public DecimalApportionment(){
        this.decimalApportionmentMap = new HashMap<>();
    }
    public DecimalApportionment(HashMap<State, Double> rawRepresentatives) {
        this.decimalApportionmentMap= rawRepresentatives;
    }
